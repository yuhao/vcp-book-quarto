...
We will start from the highest level of abstraction, where photoreceptors can be seen as a photon counting device.
...
It is worth noting that even though cone pigments regenerate much faster than rods (@sec-chpt-hvs-receptor-counter), a slower pigment regeneration rate unlikely affects the saturation in rods.
...
### Peak Response is Not Linearly Proportional to Light Intensity
