...
![Dendritic field sizes (of two RGC subtypes) increase with eccentricity, indicating a higher degree of neural convergence at the periphery. From @wandell1995foundations[Fig. 5.7], which is after @dacey1992dendritic[Fig. 2A].](figs/dendritic_tree){#fig-dendritic_tree width="80%"}
...
David Hubel and Torsten Wiesel were the first to elucidate the responses of V1 neurons and the architecture of V1 in general [@hubel1959receptive; @hubel1962receptive; @hubel1968receptive] ^[They won the Nobel Prize in 1981.].
...
The left panel of \Fig{fig:orientation_selectivity} shows the responses of a cat V1 neuron, recorded by \citet{hubel1959receptive}, when presented with a slit of illumination at different orientations.
...
The right panel in \Fig{fig:orientation_selectivity} plots the neuron responses (spikes/second) as a function of the illumination orientation; a plot like this is called the neuron's orientation \textbf{tuning curve}.
...
These neurons play a role in encoding corners, curvatures, and sudden breaks in lines [@hubel1995eye, p. 85].
