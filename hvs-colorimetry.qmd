...
In @sec-chpt-hvs-color-cme, we have seen two ways to geometrically interpret a color as a point in a three-dimensional space: the cone space and the CIE 1931 RGB space.
...
@fig-hvs_gamut visualizes the HVS gamut in both the XYZ space and the xy-chromaticity diagram.
...
* We know that a color space is defined by its three primary colors *and* the white point, which you get to choose when building your own color cube.
