...
Color discrimination experiments typically use a four-alternative forced choice (4AFC) paradigm [@krauskopf1992color; @hansen2009color; @duinkharjav2022color], shown in @fig-color_disc (a).
...
A participant is instructed to identify which one of the 4 color disks appeared different.
